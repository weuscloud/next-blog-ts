---
title: 'date-fns 时间格式化组件'
excerpt: 'modern javascript date utility library'
coverImage: 'https://raw.githubusercontent.com/date-fns/date-fns/master/docs/logotype.svg'
